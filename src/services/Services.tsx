            ...
            <section
                ...
                >
                    ...
                    <div className="w-full md:w-1/3 text-center md:text-left px-6 mt-8 md:mt-0 bg-white mr-3 flex flex-col items-center rounded-2xl h-120">
                        <img src={computer} className="h-16 w-16 m-4" />
                        <h3 className="text-[#31065A] font-bold m-2">Web Development</h3>
                    ...
                    <div className="w-full md:w-1/3 text-center md:text-left px-6 mt-8 md:mt-0 bg-white mr-3 flex flex-col items-center rounded-2xl h-120">
                        <img src={mobile} className="h-16 w-16 m-4"/>
                        <h4 className="text-[#31065A] font-bold m-2">Apps Development</h4>
                    ...
                    <div className="w-full md:w-1/3 text-center md:text-left px-6 mt-8 md:mt-0 bg-white mr-3 flex flex-col items-center rounded-2xl h-120">
                        <img src={digitalmarketing} className="h-16 w-16 m-4" />
                        <h4 className="text-[#31065A] font-bold m-2" >Digital Marketing</h4>
